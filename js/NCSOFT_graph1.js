...
(lib.Image_0 = function() {
	this.spriteSheet = ss["NCSOFT_graph1_atlas_"];
	this.gotoAndStop(0);
...
// stage content:
(lib.NCSOFT_graph1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance.parent = this;
	this.instance.setTransform(260.3,266.3,1,1,0,0,0,219.7,46.5);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(59).to({_off:false},0).to({y:276.3,alpha:1},5).wait(11));

	// t10
	this.instance_1 = new lib.gp1_t10("synched",0);
	this.instance_1.parent = this;
	this.instance_1.setTransform(260.3,266.3,1,1,0,0,0,219.7,46.5);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(56).to({_off:false},0).to({y:276.3,alpha:1},5).wait(14));

	// t9
	this.instance_2 = new lib.gp1_t9("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(260.3,266.3,1,1,0,0,0,220.3,46.5);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(53).to({_off:false},0).to({y:276.3,alpha:1},5).wait(17));

	// t8
	this.instance_3 = new lib.gp1_t8("synched",0);
	this.instance_3.parent = this;
	this.instance_3.setTransform(260.3,266.3,1,1,0,0,0,220.2,46.5);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(50).to({_off:false},0).to({y:276.3,alpha:1},5).wait(20));

	// t7
	this.instance_4 = new lib.gp1_t7("synched",0);
	this.instance_4.parent = this;
	this.instance_4.setTransform(260.3,266.3,1,1,0,0,0,221.1,46.5);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(47).to({_off:false},0).to({y:276.3,alpha:1},5).wait(23));

	// t6
	this.instance_5 = new lib.gp1_t6("synched",0);
	this.instance_5.parent = this;
	this.instance_5.setTransform(260.3,266.3,1,1,0,0,0,220.1,46.5);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(44).to({_off:false},0).to({y:276.3,alpha:1},5).wait(26));

	// t5
	this.instance_6 = new lib.gp1_t5("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(260.3,266.3,1,1,0,0,0,220.5,46.5);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(41).to({_off:false},0).to({y:276.3,alpha:1},5).wait(29));

	// t4
	this.instance_7 = new lib.gp1_t4("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(260.3,266.3,1,1,0,0,0,220.6,46.5);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(38).to({_off:false},0).to({y:276.3,alpha:1},5).wait(32));

	// t3
	this.instance_8 = new lib.gp1_t3("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(260.3,266.3,1,1,0,0,0,220.5,46.5);
	this.instance_8.alpha = 0;
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(35).to({_off:false},0).to({y:276.3,alpha:1},5).wait(35));

	// t2
	this.instance_9 = new lib.gp1_t2("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(260.2,266.3,1,1,0,0,0,220.3,46.5);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(32).to({_off:false},0).to({y:276.3,alpha:1},5).wait(38));

	// t1
	this.instance_10 = new lib.gp1_t1("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(136,195.4,1,1,0,0,0,95,9.1);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(29).to({_off:false},0).to({y:205.4,alpha:1},5).wait(41));

	// bar
	this.instance_11 = new lib.gp1_bar_gp("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(260.3,296.3,1,1,0,0,0,248.3,117.6);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(21).to({_off:false},0).to({y:276.3,alpha:1},8).wait(46));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(12).to({_off:false},0).to({x:419.7,alpha:1},4).wait(59));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(9).to({_off:false},0).to({x:198.7,alpha:1},4).wait(62));
